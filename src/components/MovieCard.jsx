    ...
    >
      ...
      >
        <figure className="relative flex w-50 max-[513px]:w-40 min-[2048px]:w-80">
          ...
          {/* hover 박스 */}
          <section className="pointer-events-none absolute w-full h-full p-1 flex flex-col justify-start text-pretty items-center py-12 max-[513px]:py-10 text-white bg-black/60 rounded-2xl opacity-0 group-hover:opacity-100 active:opacity-100 transition-opacity duration-500">
            <p
